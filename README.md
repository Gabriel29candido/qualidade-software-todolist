# Projeto To-Do List - Qualidade de Software
...
* **CI/CD:** Pipeline automatizada via GitHub Actions.
* **Testes:** Testes unitários para validação de tarefas.
* **Revisão:** Fluxo de Pull Request com análise de qualidade.
